...
do
	fname=${file/.mp4}
	fname=${fname/.mov}
  ffmpeg -i $file -pix_fmt bgr8 images/"$fname"_frame_%05d.jpg  
done
...
# extract features
colmap feature_extractor --database_path colmap/database.db --image_path images --ImageReader.single_camera 1 --ImageReader.camera_model --SiftExtraction.use_gpu 0

# match images
# colmap vocab_tree_matcher --database_path ./colmap/database.db --SiftMatching.use_gpu --VocabTreeMatching.vocab_tree_path ../vocab_tree.fbow
